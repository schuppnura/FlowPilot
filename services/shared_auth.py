...
#
# Bearer token validation using Keycloak introspection for end-to-end authentication
# across all FlowPilot services. Supports both user tokens and service-to-service
# authentication via client credentials grant.
#
# Shared authentication utilities for FlowPilot services.
#
