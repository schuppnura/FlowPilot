...
def generate_opa_persona_config(policy_name: str = "travel"):
    ...
    # Write JSON file with warning header
    try:
        with open(output_path, 'w', encoding='utf-8') as f:
            # Write warning comment (JSON doesn't support comments, but this is clear enough)
            f.write("// AUTO-GENERATED FILE - DO NOT EDIT\n")
            f.write("// This file is generated from manifest.yaml\n")
            f.write("// To make changes, edit manifest.yaml and regenerate with:\n")
            f.write("//   python3 scripts/generate-opa-persona-config.py travel\n")
            f.write("\n")
